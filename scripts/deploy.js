...
async function main() {
  ...
  // Constructor args: token being sold, then the wallet that collects USDC.
  const presaleContract = await SkyForgedTokenSale.deploy(
    "0x6E202Cbb1bDCA017ee34dA4af91cedAEfb055b96",
